...
public class WithdrawCourse extends JFrame implements ActionListener{
    ...
    public WithdrawCourse(){
        ...
        CourseCombobox = new JComboBox(this.getCourses());
        CourseCombobox.setSelectedIndex(-1);
        CourseCombobox.setBounds(200, 30, 140, 28);
        CourseCombobox.addActionListener(this);
        middlePanel.add(CourseCombobox);
        
        Withdraw = new JButton("Withdraw");
        Withdraw.setFont(new Font(Font.SERIF,Font.BOLD, 15));
        Withdraw.setHorizontalAlignment(JButton.CENTER);
        Withdraw.addActionListener(this);
        add(Withdraw, BorderLayout.SOUTH);
