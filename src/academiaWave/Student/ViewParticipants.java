...
public class ViewParticipants extends JFrame implements ActionListener{
    ...
    public ViewParticipants(){
        ...
        CoursesComboBox = new JComboBox(this.getMyCourses());
        CoursesComboBox.setSelectedIndex(-1);
        CoursesComboBox.setBounds(200, 50, 140, 28);
        CoursesComboBox.addActionListener(this);
        middlePanel.add(CoursesComboBox);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == CoursesComboBox){
            // to Clear all records from JTable
            model.setRowCount(0);
            // to Clear all Columns from JTable
            model.setColumnCount(0);
            Object selected = CoursesComboBox.getSelectedItem();
